...
but the review itself is out of scope until M7 ("Presentable") is approached
with real public rollout in mind. (Renumbered "M5" → "M6" → "M7" as later
games kept getting inserted ahead of it in `docs/ROADMAP.md` —
2026-07-28.) Tracked in `BACKLOG.md`.
